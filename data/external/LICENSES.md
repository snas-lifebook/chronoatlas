...
| 파일 | 출처 | 라이선스 | 비고 |
|---|---|---|---|
| ne_10m_land.geojson | Natural Earth 10m (nvkelso/natural-earth-vector) | Public Domain | → layers/land.geojson, bbox -15,20,65,60 |
| ne_10m_coastline.geojson | Natural Earth 10m (nvkelso/natural-earth-vector) | Public Domain | → layers/coast.geojson, bbox -15,20,65,60 |
| ne_10m_rivers_lake_centerlines.geojson | Natural Earth 10m (nvkelso/natural-earth-vector) | Public Domain | → layers/rivers.geojson, bbox -15,20,65,60 |
...
생성: scripts/fetch-external.ts · 2026-09-09
