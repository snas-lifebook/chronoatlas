...
작성 2026-09-17 저녁. 슬라이스 I(`OVERHAUL.md` §3)이 닫힌 뒤 쓴다. **초안이다. River 승인 전에는 구현하지 않는다**(취향 판정이 절반이다). 승인되면 `docs/plans/2026-09-18-overhaul-II-*.md` 계획으로 내려간다.
