...
| p12-palatine-753 | 일곱 언덕 · BC 753 | -753 | 로마 미시지도 z13(`micro: roma`), 언덕 일곱·티베리스강·마르스 광장만(성벽·포룸·문·가도는 `built_year`로 숨김, 도판은 `from_year`), 로물루스 말(`ruled 로마 -753` ✔) | -800 버킷에 로마 폴리곤 없음(L-T 실측, BC 280부터). 알바롱가는 제안 | ● |
