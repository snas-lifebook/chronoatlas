...
- **베이스맵**: Natural Earth 10m(육지·해안·강·호수·빙하·수심 7단·바다/지역명) + **10m Gray Earth 음영기복(4800×2400, 하계망 각인)** + 자체 글리프. 기하 3D는 `TERRAIN=1 npm run fetch-external`(AGENTS.md) + Pleiades 지형지물 3,552점(산·강·곶·고개·호수·섬…, CC BY). 런타임 외부 호출 0.
